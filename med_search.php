            ...
            <div class="box-body">
              <ul class="products-list product-list-in-box">
                <li class="item">
                  ...
                  <iframe src="/map/index.php?lat=<?php echo $mrow['lati']; ?>&long=<?php echo $mrow['longi']; ?>" id="googleMap<?php echo $i;?>" style="width:100%;height:400px;"></iframe>
