...
<script type="text/javascript">
  function upvoteinc(id)
    {
      var xmlhttp=new XMLHttpRequest();
      xmlhttp.open("GET","updown/upvote.php?id="+id.substring(7),false);
      xmlhttp.send(null);
      var userdata=xmlhttp.responseText;
      var currbutton=document.getElementById(id);
      currbutton.innerHTML=userdata+'&nbsp&nbsp<i class="fa fa-thumbs-o-up"></i>';
    }

    function downvoteinc(id)
    {
      var xmlhttp=new XMLHttpRequest();
      xmlhttp.open("GET","updown/downvote.php?id="+id.substring(7),false);
      xmlhttp.send(null);
      var userdata=xmlhttp.responseText;
      var currbutton=document.getElementById(id);
      currbutton.innerHTML=userdata+'&nbsp&nbsp<i class="fa fa-thumbs-o-down"></i>';
    }
</script>
  ...
  <div class="content-wrapper">
    ...
    <div class="row" style="background-color:#ecf0f5;height:5px;">
      ...
      <?php
        ...
        $storequery="SELECT * FROM forum_question ORDER BY (upvote-downvote) DESC";
        ...
        <div class="col-md-7 col-md-offset-1 forum">
          ...
          <div class="box box-primary" style="border-top-color:#d2d6de;">
            <div class="box-header with-border bg-title" style="">
              <h3 class="box-title" style="color:white;">Forums</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <li class="item">
                  <div>
                    <div class="product-img">
                      <img class="prod-img" src="images/forum/<?php
                      if(file_exists('images/forum/'.$store_rows['topic_id'].'.jpg'))
                    	  {
                          echo $store_rows['topic_id'];             //incomplete
                    	  }else
                    	  {
                          echo 'defaultnew';
                        }
                    ...
                    <div class="product-info" style="margin-left:115px;">
                      ...
                      <a class="font-head" style="color:grey;font-size:17px;" href="profile.php?id=<?php echo $store_rows['id'];?>">
                        <?php echo '<b>'.$store_rows['name'].'</b>'; ?>
                      </a>
                      <br>
                      <?php $id=$store_rows['topic_id']; ?>
                      <a href="view_topic.php?id= <?php echo $id; ?>" class="product-title font-head" style="margin-left:10px;font-size:17px;"><?php echo $store_rows["topic"]; ?>
                    ...
                    <span style="margin-left:10px;margin-top:3px;font-size:14px;" class="label label-success pull-left"><?php echo $store_rows["view"];?> Views</span>&nbsp
                    <span style="margin-left:10px;margin-top:3px;font-size:14px;margin-left:5px" class="label label-danger pull-left"><?php echo $store_rows["reply"]?> Reply</span>  
                    
                    <button type="submit"  id="<?php echo 'button2'.$store_rows['topic_id']; ?>" class="btn pull-right btn-danger" onclick="downvoteinc(this.id);"><?php echo $store_rows['downvote'];?>&nbsp &nbsp<i class="fa fa-thumbs-o-down" ></i></button>

                    <button type="submit"  id="<?php echo 'button1'.$store_rows['topic_id']; ?>" class="btn pull-right btn-success" style="margin-right: 5px;" onclick="upvoteinc(this.id);"><?php echo $store_rows['upvote'];?>&nbsp &nbsp<i class="fa fa-thumbs-o-up"></i></button>
        ...
        <div class="col-md-3 forum2" style="">
          <div class="box box-default">
            ...
            <div class="box-footer text-center" style="padding:50px">
              <a href="create_topic.php"><button type="button" class="btn btn-success">Create a Forum</button></a>
            </div>
            <!- - /.footer -->
          </div>
          <!-- /.box -->
