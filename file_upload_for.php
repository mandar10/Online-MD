...
<style>
  ...
  <div class="content-wrapper">
    <section class="content">
      ...
      {
          require 'upload_script/for_data.php';
           ...
           if(isset($name))
            {
              if(!empty($name))
          	{
          	   $location="images/forum/";
          	   $location1="images/forumthumbs/";
      ...
      <div class="row" style="margin:10px -7px; ">
        ...
        <div class="col-md-7 col-md-offset-1 forum">
          ...
          <div class="box box-primary" style="border-top-color:#d2d6de;">
            ...
            <div class="box-body">
              <div>
            <form class="form-horizontal" id="form1" name="form1" method="post" action="file_upload_for.php" enctype="multipart/form-data">
              <div class="box-body">
              ...
              <div class="box-footer">
                <a href="main_forum.php"><button type="button" class="btn btn-default">Skip this Step</button></a>
