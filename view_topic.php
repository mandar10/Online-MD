...
<script type="text/javascript">
  function upvoteinc(id,tid)
    {
      var xmlhttp=new XMLHttpRequest();
      xmlhttp.open("GET","updown/upvote_topic.php?id="+id.substring(7)+"&tid="+tid,false);
      xmlhttp.send(null);
    ...
    function downvoteinc(id,tid)
    {
      var xmlhttp=new XMLHttpRequest();
      xmlhttp.open("GET","updown/downvote_topic.php?id="+id.substring(7)+"&tid="+tid,false);
      xmlhttp.send(null);
      var userdata=xmlhttp.responseText;
      var currbutton=document.getElementById(id);
              ...
              <div class="col-lg-9 col-sm-12 col-xs-12">
                <div class="description-block commentsec" style="padding-left:20px;">
                  ...
                  <div class="box-footer box-comments">
                    ...
                    $sql2="SELECT * FROM $tbl_name2 WHERE question_id='".mysqli_real_escape_string($con,$id)."' ORDER BY (upvote-downvote) DESC";
                     ...
                     ?>
                                <div class="box-comment">
                                  ...
                                  <div class="comment-text">
                                    ...
                                    <button type="submit"  id="<?php echo 'button2'.$rows['a_id']; ?>" class="btn pull-right btn-danger" onclick="downvoteinc(this.id,<?php echo $rows['question_id'];?>);"><?php echo $rows['downvote'];?>&nbsp &nbsp<i class="fa fa-thumbs-o-down" ></i></button>

                                    <button type="submit"  id="<?php echo 'button1'.$rows['a_id']; ?>" class="btn pull-right btn-success" style="margin-right: 5px;" onclick="upvoteinc(this.id,<?php echo $rows['question_id']; ?>);"><?php echo $rows['upvote'];?>&nbsp &nbsp<i class="fa fa-thumbs-o-up"></i></button>
                                  </div>
                                  <!-- /.comment-text -->
                                </div>
                                <!-- /.box-comment -->
