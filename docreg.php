          ...
          <div class="form-box" >
            ...
            <div class="form-bottom" style="display:<?php if(($_GET['redirect'])=='reg'){echo'none';}?>;">
                <form role="form" action="login_reg_scripts/proreg.php" method="post" class="registration-form">
                  ...
                  <div class="form-group">
                    <label class="sr-only" for="form-first-name">Speciality</label>
                      <input type="text" name="special" placeholder="Speciality..." class="form-first-name form-control" id="form-first-name">
                  </div> 
                  <div class="form-group"  style="display: none;">
                    <label class="sr-only" for="form-first-name"></label>
                      <input type="text" value="2" name="type" placeholder="" class="form-first-name form-control" id="form-first-name">
                  </div> 
