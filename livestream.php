...
<div class="content-wrapper"
  ...
  <section class="content-header" style="border-bottom:solid 1px silver;padding-top:10px;padding-bottom:10px;margin:10px;">
    <h1>
        <?php echo "Live stream of  ".$rowsl["sub"]." by Dr. ".$rowsl['tfname']." ".$rowsl['tlname'] ;?>
    </h1>
  </section>
  <!-- Main content -->
    ...
    <div class="col-md-6 col-md-offset-2">
              ...
              <div class="box box-widget">
                ...
                <div class="box-body">
                  ...
                  <center><iframe src="http://d3kedutmscl43l.cloudfront.net/iframe.htm?v=8H8uUSS&w=600&h=338" style="border-width:0;width:600px;height:338px" scrolling="no" allowFullScreen></iframe></center>
                  <p><?php echo 'Live stream of '.$rowsl["sub"].' started on '.$rowsl["sdate"];?></p>
